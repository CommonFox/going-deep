...
| `defense_matchup.ipynb` | Whether "defense vs. position" predicts beyond a player's own recent scoring: yes, per position (QB > RB > TE > WR, against the common TE/DST claim), not at all pooled, not yet testable against the vendor projection (#117's 2026 gap), and not before three games of evidence. |
